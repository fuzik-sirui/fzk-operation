...
class FilterTable extends Component {
  constructor(props) {
    super(props);
    const self = this;
    const { filterList, filterGrade, filterForm, fetch, addBtn, rowKey, opreat, tableList, otherList, localName, pagination, menuClick, scroll, onAdd } = this.props;
    const filterParams = {
      filterList,
      filterGrade,
      filterForm,
